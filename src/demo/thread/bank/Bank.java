...
public class Bank {
    ...
    public synchronized void outMoney(double money, OutMode mode, String name) throws Exception {
        if (money > totalMoney) {
    ...
    private void WithdrawMoney(double money, OutMode mode, String name) {
        totalMoney -= money;
